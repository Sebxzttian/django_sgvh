...
<<<<<<< Updated upstream:sgvh/horarios/urls.py
...
>>>>>>> Stashed changes:sgvh1/horarios/urls.py
)
...
=======
    ...
    # Descargar plantilla de instructores
    path('instructores/download-template/', 
         views.download_instructor_template, 
         name='download_instructor_template'),
