...
class AdministradorForm(UserCreationForm):
    ...
    class Meta:
        model = Administrador
        fields = ['nombres', 'apellidos', 'numero_cedula', 'numero_celular', 'correo_institucional', 'correo_personal', 'password1', 'password2']
        widgets = {
...
class ProgramaFormacionForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'instructores': forms.SelectMultiple(attrs={'class': 'form-control'}),
        }
...
class AmbienteForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'programa_formacion': forms.Select(attrs={'class': 'form-control'}),
            'instructores': forms.SelectMultiple(attrs={'class': 'form-control'}),
        }
...
class CompetenciaForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'codigo_norma': forms.TextInput(attrs={'class': 'form-control'}),
